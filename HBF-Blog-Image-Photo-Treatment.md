...
When generating images for Heidi Blondin Financial (HBF), apply these colours to backgrounds, overlays, gradients, text, and accents:

| Token | Hex | Use |
|-------|-----|-----|
| Plum (primary) | `#593D58` | Main backgrounds, headers, deep overlays |
| Plum Mid | `#7A5577` | Secondary backgrounds, gradients |
| Plum Dark | `#3F2C3E` | Deep backgrounds, rich shadows |
| Sage | `#A2A47D` | Supporting accent, nature tones |
| Sage Dark | `#7A7D5E` | Deeper sage accent |
| Gold | `#B87B1E` | Highlight colour, accents, warm light |
| Gold Light | `#D4973A` | Softer gold, warm glow effects |
| Tint Plum | `#F5F0F5` | Light background washes |
| Tint Sage | `#F2F2EA` | Light neutral backgrounds |
| Page BG | `#F0ECF0` | Overall page wash, off-white |
| Ink | `#222222` | Dark text, shadow elements |
| Ink Soft | `#141413` | Near-black for maximum contrast |

**Applying in prompts:** Reference colours by hex when precision matters — e.g., *"deep plum (#593D58) background with warm gold (#B87B1E) accent lighting."*
